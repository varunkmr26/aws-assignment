aws dynamodb create-table --table-name varun-pe-shell \
...
--code S3Bucket="varun-pe-script-bucket",S3Key="lambda.zip",S3ObjectVersion="Latest Version" \
--memory-size 512 \
--timeout 10 \
--region us-east-1
...
echo "$APIID $NAME $REGION" > ids.txt
